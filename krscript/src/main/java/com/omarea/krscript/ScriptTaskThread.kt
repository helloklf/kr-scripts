...
class ScriptTaskThread(private var process: Process) : Thread() {
    ...
    class ServiceShellHandlerBase(private val context: Context, private val clickableNode: ClickableNode, private val notificationID: Int, private val finishedIntent: Intent) : ShellHandlerBase() {
        private var notificationManager: NotificationManager = context.getSystemService(Context.NOTIFICATION_SERVICE) as NotificationManager
        private val notificationTitle = clickableNode.title
        ...
        private fun updateNotification() {
            ...
            expandView.setViewVisibility(R.id.kr_task_stop, if ((forceStop == null && !clickableNode.interruptable) || isFinished) View.GONE else View.VISIBLE)
            if (clickableNode.interruptable && forceStop != null && !isFinished) {
    ...
    companion object {
        ...
        fun startTask(context: Context, script: String, params: HashMap<String, String>?, nodeInfo: ClickableNode, onExit: Runnable, onDismiss: Runnable): BroadcastReceiver {
